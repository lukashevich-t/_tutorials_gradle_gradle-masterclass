...
public class RegistrationControllerIT {
    ...
    public void readRegistrationIT() {
        ...
        assertTrue("Registration student name is not correct",
                returnRegistration.getStudent().getName().equals("Jim Sparrow"));
        assertTrue("Registration course name is not correct",
                returnRegistration.getCourse().getName().equals("Spring101"));
